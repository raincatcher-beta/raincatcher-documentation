...
In addition to this, a demo application is provided as a project template that showcases how these modules can be assembled into an application. See [this guide](Demo-Solution-Architecture.md) for the demo application architecture.
...
8. Set the auth policy name as the `WFM_AUTH_POLICY_ID`.
  ...
  6. Enter `WFM_AUTH_POLICY_ID` for the **name**, and set the auth policy name created in step 5 for the **value** (e.g. **wfm**).
